...
exports.formatInstruction = exports.humanPrompt_new = exports.systemPrompt_new = exports.humanPrompt = exports.systemPrompt = void 0;
exports.systemPrompt = `당신은 웹 UI 테스트 자동화 전문가입니다. 1920x1080 해상도의 웹 페이지 스크린샷을 분석하여 다음 작업을 수행하세요:
...
7. 결과: (결과에 JSON 외에 다른 정보를 넣지 않는다.)
  ...
  1. 응답값에 JSON 만!!!!
  `;
exports.humanPrompt = `다음 1920x1080 해상도의 웹 페이지 스크린샷을 분석하여 UI 컴포넌트들의 위치와 목록을 제공해주세요: {base64_image}`;
exports.systemPrompt_new = `당신은 웹 UI 전문가입니다. 1920x1080 해상도의 웹 페이지 스크린샷을 분석하여 다음 작업을 수행하세요:
...
`;
exports.humanPrompt_new = `다음 1920x1080 해상도의 웹 페이지 스크린샷을 분석하여 UI 컴포넌트들의 목록을 제공해주세요:`;
exports.formatInstruction = `{{ 
