...
exports.getScreenshot = exports.mouseClick = exports.mouseMove = exports.goToPage = void 0;
exports.runAutomation = runAutomation;
exports.createGridOverlay = createGridOverlay;
// Puppeteer 자동화 함수
...
async function runAutomation(browser) {
    ...
    try {
        ...
        console.log("마우스 이동...");
        await mouseMove(page, { x: 400, y: 230, delay: 100 }, { width: 0, height: 0 });
        console.log("마우스 클릭...");
...
const mouseMove = async (page, coord, size) => {
    ...
    await page.evaluate((posX, posY, width, height) => {
        // 기존 커서가 있다면 제거
